...
values ('01.001', 'Chuyên viên cao cấp', 1),
       ...
       ('08.049', 'Kiểm tra viên cao cấp hải quan', 1),
       ('07.044', 'Kiểm soát viên cao cấp ngân hàng', 1),
       ('06.041', 'Kiểm toán viên cao cấp', 1),
       ('03.299', 'Chấp hành viên cao cấp', 1),
       ('03.230', 'Thẩm tra viên cao cấp', 1),
       ('21.187', 'Kiểm soát viên cao cấp thị trường', 1),
