...
@Entity
@Table(name = "kien_thuc_anninh_quocphong")
@Getter
@Setter
@SuperBuilder
@NoArgsConstructor
...
public class KienThucAnNinhQuocPhong extends DateTimeObject {
    @Id
    ...
    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "loai_so_yeu_ly_lich_chitiet_ktanqp_fk"), name = "loai_so_yeu_ly_lich_chitiet", referencedColumnName = "id", columnDefinition = "INTEGER")
    ...
    public KienThucAnNinhQuocPhong(LocalDateTime batDau, LocalDateTime ketThuc, String tenCoSoDaoTao, String chungChiDuocCap, LoaiSoYeuLyLichChiTiet loaiSoYeuLyLichChiTiet, SoYeuLyLich soYeuLyLich) {
        super();
        this.batDau = batDau;
