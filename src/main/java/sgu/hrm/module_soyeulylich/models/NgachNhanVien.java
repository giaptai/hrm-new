...
public class NgachNhanVien extends DateTimeObject {
    ...
    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "ngach_cong_chuc_fk"), name = "ngach_cong_chuc", referencedColumnName = "id", columnDefinition = "INTEGER")
    NgachCongChuc ngachCongChuc;

    @ManyToOne
    @JoinColumn(foreignKey = @ForeignKey(name = "ngach_vien_chuc_fk"), name = "ngach_vien_chuc", referencedColumnName = "id", columnDefinition = "INTEGER")
    ...
    public NgachNhanVien(NgachCongChuc ngachCongChuc, NgachVienChuc ngachVienChuc, LocalDateTime ngayBoNhiemNgach,
